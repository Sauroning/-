...
class Calc {
    ...
    public static String parse(String expression) throws Exception {
        ...
        if (operands.length != 2) throw new Exception("Должно быть 2 значения");
        oper = detectOperacion(expression);
        ...
        (!Roman.isRoman(operands[0]) && !Roman.isRoman(operands[1])) {
